...
const SEED = {
  weeks: [
    ...
    sk(2, 1, "Precio del riesgo y portafolio óptimo", "Caps. 10 y 11", ""),
  ...
  return (
    <div className="root">
      ...
      {view === "home" && (
        <main>
          <section className="hero">
            <div>
              <div className="eyebrow">Universidad del Pacífico · Guía interactiva complementaria</div>
              <h1 className="h1">Finanzas<br />Corporativas <span className="blue">1</span></h1>
              <p className="lead">
                Dieciséis semanas, tres unidades. Cada concepto de clase explicado con un modelo que
                puedes mover, y una autoevaluación al final para comprobar que lo entendiste.
              </p>
              <div className="cta">
                <button className="btn-solid" onClick={() => open("w1")}>Empezar por la semana 1</button>
                <a className="btn-ghost" href="#programa">Ver el programa</a>
              </div>
            </div>
            <div className="hero-art"><HeroCurve /></div>
          </section>
      ...
      {view === "week" && (
        <main className="wk">
          ...
          {week.sections.length === 0 && !edit && (
            <div className="blank">
              Esta semana todavía está vacía. Si eres el autor, entra en <b>Editar</b> para agregar
              temas — o pídeselo a Claude en el chat.
            </div>
          )}
      ...
      <footer className="foot">
        Finanzas Corporativas 1 · Guía interactiva complementaria
      </footer>
    </div>
  );
}
...
.h1{font-family:var(--disp); font-size:64px; line-height:.99; font-weight:600; letter-spacing:-.025em;
  margin:18px 0 22px;}
.blue{color:var(--blue);}
.lead{font-size:17px; color:var(--ink2); max-width:46ch; margin:0 0 30px;}
...
@media (max-width:820px){
  ...
  .h1{font-size:44px;} .hero-art{display:none;}
